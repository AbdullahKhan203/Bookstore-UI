...
export default function Content() {
  return (
    <div className="w-[85%] h-auto m-auto flex flex-col lg:flex-row">
      <div className="left w-[100%] lg:w-[70%]">
        <div className="first-card w-[100%] h-auto shadow-md relative my-8">
          <div className="img w-[100%] h-[350px] sm:h-[428px]">
            <Image
      ...
      <div className="right w-[100%] lg:w-[30%] my-8">
        ...
        <div className="catagory bg-[#fbf9ff] my-6">
          ...
          <div className="px-8">
            <ul className="flex flex-col gap-4 my-4 font-extralight">
              <li className="border-b">Restaurant Food</li>
              <li className="border-b">Travel News</li>
              <li className="border-b">Modern Technology</li>
              <li className="border-b">Product</li>
              <li className="border-b">Inspiration</li>
          ...
          <div className="px-8">
            <ul className="flex flex-col gap-4 my-4 font-extralight">
              <li>
                <div className="h-[47px] flex">
                  <div className="img">
                    <Image src={postImage1} className="h-[47px] w-[48px]" alt="image" />
                  </div>
                  <div className="content flex flex-col ml-4">
                    <div className="heading">From List Fish</div>
                    <div className="date">Date</div>
              ...
              <li>
                <div className="h-[47px] flex">
                  <div className="img">
                    <Image src={postImage2} className="h-[47px] w-[48px]" alt="alt" />
                  </div>
                  <div className="content flex flex-col ml-4">
                    <div className="heading">From List Fish</div>
                    <div className="date">Date</div>
              ...
              <li>
                <div className="h-[47px] flex">
                  <div className="img">
                    <Image src={postImage3} className="h-[47px] w-[48px]" alt="image"   />
                  </div>
                  <div className="content flex flex-col ml-4">
                    <div className="heading">From List Fish</div>
                    <div className="date">Date</div>
              ...
              <li>
                <div className="h-[47px] flex">
                  <div className="img">
                    <Image src={postImage4} className="h-[47px] w-[48px]" alt="image" />
                  </div>
                  <div className="content flex flex-col ml-4">
                    <div className="heading">From List Fish</div>
                    <div className="date">Date</div>
        ...
        <div className="tag-cloud bg-[#fbf9ff] my-6">
          <div className="heading h-[40px] flex items-center ml-8">
            Tag Cloud
          </div>
          <hr className="w-[80%] mx-auto" />
          <div className="px-8 flex flex-wrap">
            ...
            <button className="w-auto h-[25px] bg-white m-1 px-1">technology</button>
            <button className="w-auto h-[25px] bg-white m-1 px-1">travel</button>
            <button className="w-auto h-[25px] bg-white m-1 px-1">restaurant</button>
            <button className="w-auto h-[25px] bg-white m-1 px-1">lifestyle</button>
            <button className="w-auto h-[25px] bg-white m-1 px-1">design</button>
            <button className="w-auto h-[25px] bg-white m-1 px-1">illustration</button>
          </div>
        </div>
        <div className="instagram-feed bg-[#fbf9ff] my-6">
          ...
          <hr className="w-[80%] mx-auto" />
          <div className="px-8 flex flex-wrap my-6">
            <Image src={firstCardImg} className="h-[70px] w-[70px] m-1"  alt="image"/>
            <Image src={secondCardImg} className="h-[70px] w-[70px] m-1"  alt="image"/>
            <Image src={thirdCardImg} className="h-[70px] w-[70px] m-1"  alt="image"/>
            <Image src={forthCardImg} className="h-[70px] w-[70px] m-1"  alt="image"/>
            <Image src={fifthCardImg} className="h-[70px] w-[70px] m-1"  alt="image"/>
          </div>
        </div>
        <div className="newsletter bg-[#fbf9ff] my-6">
          <div className="heading h-[40px] flex items-center ml-8">
            Newsletter
          </div>
          <hr className="w-[80%] mx-auto" />
          <div className="px-1 h-auto flex flex-col mt-6 mb-8">
            <div className="input h-[35px] w-[250px] bg-transparent flex justify-center items-center bg-white m-auto my-1">
              <input
                type="search"
                className="h-[30px] w-[220px] px-1 outline-none"
                placeholder="Enter email"
              />
            </div>
            <button className="h-[40px] w-[250px] bg-white hover:bg-[#ff1616] m-auto border my-1 mb-6">
              Subscribe
            </button>
          </div>
        </div>
